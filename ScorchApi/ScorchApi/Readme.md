...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ScorchApi*):
...
Execute unit tests
```
    cd "ScorchApi/test/ScorchApi.Tests"
    dotnet test
```

Deploy application
```
    cd "ScorchApi/src/ScorchApi"
