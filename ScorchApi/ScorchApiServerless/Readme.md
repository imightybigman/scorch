...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ScorchApiServerless*):

Restore dependencies
```
    cd "ScorchApiServerless"
    dotnet restore
```

Execute unit tests
```
    cd "ScorchApiServerless/test/ScorchApiServerless.Tests"
    dotnet test
```

Deploy application
```
    cd "ScorchApiServerless/src/ScorchApiServerless"
